...
Below are the common configuration options that you may want to set, exhaustive list is in [the bridge's defaults var file](../roles/matrix/matrix-bridge-heisenbridge/defaults/main.yml).
