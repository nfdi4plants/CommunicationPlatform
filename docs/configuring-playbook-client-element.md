...
Their defaults are defined in [`roles/matrix/matrix-client-element/defaults/main.yml`](../roles/matrix/matrix-client-element/defaults/main.yml) and they ultimately end up in the generated `/matrix/element/config.json` file (on the server). This file is generated from the [`roles/matrix/matrix-client-element/templates/config.json.j2`](../roles/matrix/matrix-client-element/templates/config.json.j2) template.
...
- or, you can **extend and override the default configuration** ([`config.json.j2`](../roles/matrix/matrix-client-element/templates/config.json.j2)) by making use of the `matrix_client_element_configuration_extension_json_` variable. You can find information about this in [`roles/matrix/matrix-client-element/defaults/main.yml`](../roles/matrix/matrix-client-element/defaults/main.yml).
