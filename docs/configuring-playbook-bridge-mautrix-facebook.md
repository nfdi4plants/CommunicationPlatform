...
You may wish to look at `roles/matrix/matrix-bridge-mautrix-facebook/templates/config.yaml.j2` and `roles/matrix/matrix-bridge-mautrix-facebook/defaults/main.yml` to find other things you would like to configure.
