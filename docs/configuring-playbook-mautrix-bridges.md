...
You may wish to look at `roles/matrix/matrix-bridge-mautrix-SERVICENAME/templates/config.yaml.j2` and `roles/matrix/matrix-bridge-mautrix-SERVICENAME/defaults/main.yml` to find other things you would like to configure.
